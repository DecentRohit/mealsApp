// check and create meals api in local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// fetch meal api and return
...
// show meal card in search result
...
// its shows all favourites meals in favourites section
